...
static inline int patch_instruction_site(s32 *site, unsigned long instr)
{
	return patch_instruction((unsigned long *)patch_site_addr(site), instr);
}

static inline int patch_branch_site(s32 *site, unsigned long target, int flags)
{
	return patch_branch((unsigned long *)patch_site_addr(site), target, flags);
}
...
unsigned long translate_branch(const unsigned long *dest,
			      const unsigned long *src);
extern bool is_conditional_branch(unsigned long instr);
